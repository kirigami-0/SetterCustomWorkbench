...
# 定形レシピボタンセット
execute at @s unless data block ~ ~ ~ Items[{Slot: 4b}] run function cc_rei_dev:set_recipe/shaped
execute at @s unless data block ~ ~ ~ Items[{Slot: 4b}] run data modify block ~ ~ ~ Items[{Slot: 4b}] merge from storage cc_rei_dev: ui.ShapeButton
# 不定形レシピセット
execute at @s unless data block ~ ~ ~ Items[{Slot: 22b}] run function cc_rei_dev:set_recipe/shapeless
execute at @s unless data block ~ ~ ~ Items[{Slot: 22b}] run data modify block ~ ~ ~ Items[{Slot: 22b}] merge from storage cc_rei_dev: ui.ShapelessButton
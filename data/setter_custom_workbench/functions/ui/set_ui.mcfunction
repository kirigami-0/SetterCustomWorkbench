...
execute at @s unless data block ~ ~ ~ Items[{Slot: 5b}] run function setter_custom_workbench:left/shapeless
...
# 不定形レシピセット
execute at @s unless data block ~ ~ ~ Items[{Slot: 21b}] run function setter_custom_workbench:right/shaped
